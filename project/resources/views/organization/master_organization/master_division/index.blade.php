    ...
    <div class="col-12">
        ...
        <div class="card card-danger card-outline">
            <div class="card-header">
                <h5 class="card-title">Master Division</h5>
                <div class="card-tools">
                    <button type="button" class="new btn btn-sm btn-success"><i class="fas fa-plus"></i> Add Division</button>
                </div>
            </div>
			 ...
			 <button id="advanced" type="button" class="btn btn-default">Advanced Search</button>
					<br>
					<br>
					<table id="division_table" class="table table-striped table-bordered table-hover datatable">
					 <thead>
					  <tr>					   
						<th></th>
						<th></th>
...
<div class="modal fade" id="modal_form_division"  data-backdrop="static" data-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
function get_company(){
	$.getJSON('<?= url('organization/master_organization/master_division/get_company') ?>', function (data) {
            $('#company').select2({
                data: data,
				disabled: true
            });
...
$(document).on('click', '.new', function () {
            ...
            $("#divisionForm .modal-title").html("<span class='fas fa-plus'></span> Form Division");
            $(".invalid-feedback").children("strong").text("");
            $("#divisionForm input").removeClass("is-invalid");
            $("#divisionForm textarea").removeClass("is-invalid");
            $('#modal_form_division').modal('show');
        });
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status == 'true') {
							 $('#modal_form_division').modal('hide');
                            swal({
                                icon: 'success',
                                title: 'Success',
...
$(document).ready(function(){
  ...
  {
   action_url = "{{ route('division.update') }}";
  }
  $(".invalid-feedback").children("strong").text("");
 ...
 $(document).on('click', '.edit', function(){
  var id_division = $(this).attr('id');
  $('#form_result').html('');
  $.ajax({
   url :"master_division/edit/"+id_division,
   dataType:"json",
   success:function(data)
   {
...
$(document).on('click', '.delete', function (event) {
    ...
    swal({
       ...
       buttons: true,
        ...
        if (value) {
            $.ajax({
			   url:"master_division/destroy/"+id_division,
			   success:function(data)
			   {
				setTimeout(function(){
