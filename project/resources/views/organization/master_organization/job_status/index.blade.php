    ...
    <div class="col-12">
        ...
        <div class="card card-danger card-outline">
            <div class="card-header">
                <h5 class="card-title">Master Job Status</h5>
                <div class="card-tools">
                    <button type="button" class="new btn btn-sm btn-success"><i class="fas fa-plus"></i> Add Job Status</button>
                </div>
            </div>
			 ...
			 <button id="advanced" type="button" class="btn btn-default">Advanced Search</button>
					<br>
					<br>
					<table id="status_table" class="table table-striped table-bordered table-hover datatable">
					 <thead>
					  <tr>
...
<div class="modal fade" id="modal_form_status"  data-backdrop="static" data-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form method="POST" id="statusForm">
                {{ csrf_field() }}
                <div class="modal-header">
                    <h5 class="modal-title">Form Job Status</h5>
...
function get_company(){
	$.getJSON('<?= url('organization/master_organization/job_status/get_company') ?>', function (data) {
            $('#company').select2({
                data: data,
				disabled: true
            });
...
$(document).on('click', '.new', function () {
            $("#statusForm")[0].reset();
            $("#statusForm .modal-title").html("<span class='fas fa-plus'></span> Form Job Status");
            $(".invalid-feedback").children("strong").text("");
            $("#statusForm input").removeClass("is-invalid");
            $("#statusForm textarea").removeClass("is-invalid");
...
$(document).ready(function(){
  ...
  {
   action_url = "{{ route('status.update') }}";
  }
   $.ajax({
   url: action_url,
   method:"POST",
 ...
 $(document).on('click', '.edit', function(){
  var id_job_status = $(this).attr('id');
  $('#form_result').html('');
  $.ajax({
   url :"job_status/edit/"+id_job_status,
   dataType:"json",
   success:function(data)
   {
...
$(document).on('click', '.delete', function (event) {
    ...
    swal({
       ...
       buttons: true,
        ...
        if (value) {
            $.ajax({
			   url:"job_status/destroy/"+id_job_status,
			   success:function(data)
			   {
				setTimeout(function(){
