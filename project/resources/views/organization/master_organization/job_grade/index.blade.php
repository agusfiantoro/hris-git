    ...
    <div class="col-12">
        ...
        <div class="card card-danger card-outline">
            <div class="card-header">
                <h5 class="card-title">Master Job Grade</h5>
                <div class="card-tools">
                    <button type="button" class="new btn btn-sm btn-success"><i class="fas fa-plus"></i> Add Job Grade</button>
                </div>
            </div>
			 ...
			 <button id="advanced" type="button" class="btn btn-default">Advanced Search</button>
					<br>
					<br>
					<table id="grade_table" class="table table-striped table-bordered table-hover datatable">
					 <thead>
					  <tr>
        ...
        <div class="modal-content">
            <form method="POST" id="gradeForm">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Form Job Grade</h5>
                ...
                <div class="modal-body">
                    <div class="row">
						...
						<div class="col-md-6">
                            <div class="row">
                                <label class="col-sm-4 col-form-label">Layer</label>
                                <div class="col-sm-8">
									  <input id="job_class_group" name="job_class_group" class="form-control form-control-sm" style="width: 100%;">
                                    <span class="invalid-feedback" role="alert" id="job_class_groupError">
                                        <strong></strong>
                                    </span>
                                </div>
                            </div>
					...
					<div class="row">
						...
						<div class="col-md-6">
                            <div class="row">
                                <label class="col-sm-4 col-form-label">Layer</label>
                                <div class="col-sm-8">
									  <input name="job_class_group" id="job_class_group_edit" class="form-control form-control-sm" style="width: 100%;">
                                    <span class="invalid-feedback" role="alert" id="job_class_group_editError">
                                        <strong></strong>
                                    </span>
                                </div>
                            </div>
...
function get_company(){
	$.getJSON('<?= url('organization/master_organization/job_grade/get_company') ?>', function (data) {
            $('#company').select2({
                data: data,
				disabled: true
            });
...
$(document).on('click', '.new', function () {
            $("#gradeForm")[0].reset();
            $("#gradeForm .modal-title").html("<span class='fas fa-plus'></span> Form Job Grade");
            $(".invalid-feedback").children("strong").text("");
            $("#gradeForm input").removeClass("is-invalid");
            $("#gradeForm textarea").removeClass("is-invalid");
...
$(document).ready(function(){
    ...
    $('#grade_table').DataTable({
		...
		{ data: 'DT_RowIndex', name: 'DT_RowIndex'},
            ...
            { data: 'job_class_group', name: 'job_class_group' },
 ...
 $(document).on('click', '.edit', function(){
  var id_job_grade = $(this).attr('id');
  $('#form_result').html('');
  $.ajax({
   url :"job_grade/edit/"+id_job_grade,
   dataType:"json",
   success:function(data)
   {
    ...
    $('#job_class_group_edit').val(data.result.job_class_group);
    $('#hidden_id').val(id_job_grade);
...
$(document).on('click', '.delete', function (event) {
    ...
    swal({
       ...
       buttons: true,
        ...
        if (value) {
            $.ajax({
			   url:"job_grade/destroy/"+id_job_grade,
			   success:function(data)
			   {
				setTimeout(function(){
