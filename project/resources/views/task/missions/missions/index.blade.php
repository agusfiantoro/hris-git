			...
			<table id="missions_table" style="width:100%;" class="table table-striped table-bordered table-hover datatable">
			  <thead>
			   <tr>
				...
				<th data-priority="2" width=150 class="text text-center">Action</th>
			  </tr>
			</thead>
		  </table>
    </div>
...
$(document).ready(function(){
	...
	//	},
		...
		*/
		  ...
		  { data: 'action', name: 'action', orderable: false, className: 'text-width' }
		],
...
//	let formData = $(this).serializeArray();
	...
	if(global_type == 'Video'){
		if(typeof player.recordedData === 'undefined'){
