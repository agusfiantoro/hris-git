    ...
    <div class="card card-danger card-outline">
      ...
      <div class="card-body">
		...
		<div class="div_datatable" style="display:none;"> 
			...
			<br>
			<br>
			<table id="summary_table" style="width:100%;" class="table table-striped table-bordered table-hover datatable">
			  <thead>
...
const get_datatable = async () => {	
	...
	$('#summary_table').DataTable({
		...
		"fnInitComplete": function (oSettings) {
			$('#summary_table').find("tbody tr td.dtr-control").attr('onclick','det()');
...
function det(){
	setTimeout(function () {
			$('#summary_table > tbody > tr.child > td.child > ul > li').addClass('row');
			$('#summary_table > tbody > tr.child > td.child > ul > li > span.dtr-title').addClass('col-2');
			$('#summary_table > tbody > tr.child > td.child > ul > li > span.dtr-data').addClass('col');
	}, 500);
}
