									...
									<table id="table_rec_detail" style="width:1200px" class="table table-striped table-bordered table-hover datatable">
										<thead>
											<tr align="center" style="font-size:14px;">
												...
												<th>Bgen Position</th>
												<th style="white-space:nowrap;">Bgen Location</th>
												<th>Status</th>
												<th>Sync</th>
												<th style="white-space:nowrap;">Sales Code</th>
												<th>Sales Code Spv</th>
												<th>Sync Message</th>
												<th>Note Revised</th>
												<th>Note Rejected</th>
												<th>Approval Hierarchy</th>
												<th style="width:100%">Approved By</th>
												<th style="width:100%;min-width:200px">Direct Spv</th>
...
function get_edit(nik_employee,type) {
	...
	$.ajax({
		url: "<?= url('integration/bgen/sales_code_bgen/get_edit') ?>",
		method: "GET",
		...
		success: function (response) {
			...
			setTimeout(function () {
				$('#table_rec_body tr').each(function (index) {
					...
					$(this).find('.bgen_branch_input').val(response.bgen[index].id_branch).trigger('change');
					$(this).find('.bgen_principal_input').val(response.bgen[index].id_principal).trigger('change');
