...
<style>
  .tab-note-box {
    border:2px solid #28a745;padding:5px 20px 5px 20px;border-radius:5px;margin-top:8px;margin-bottom:8px;width:fit-content;
  }
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="row">
                ...
                <div class="col-sm-8">
                  <textarea class="form-control form-control-sm" id="reason_notes" rows="4" name="reason_notes" style="text-transform: uppercase;"></textarea>
            ...
            <div class="col-md-6">
              ...
              <div class="row">
                ...
                <div class="col-sm-8">
                  <div class="input-group id_approval_request_group">
                    <select id="id_approval_request" name="id_approval_request" class="form-control-sm select_opsi" style="margin-bottom" readonly></select>
                    <div class="input-group-append browse-approval" style="display:none;">
			  ...
			  <div style="border:2px solid #28a745;padding:5px 0 5px 20px;border-radius:5px;margin-top:8px;">
				  <div class="row">
					<div class="col-sm-12">
						<i>Note :<ul>
								<li> <i>Jika yang dipilih "Perjalanan Dinas" dan "Project", maka pengajuan maksimal H-<span class="max_label"></span> Hari Kerja.</i></li>
								<li> <i>Jika yang dipilih "Mutasi Karir", maka pengajuan maksimal H-2 Hari Kerja.</i><br></li>
              ...
              <div class="row">
                <label class="col-sm-3 col-form-label">With Cash Advance</label>
                <div class="col-sm-1">
                ...
                <div class="col-sm-7">
                  <span style="font-size: 14px;" class="text mt-3"><i>Note: Jika pengajuan maksimal H-7 Hari Kerja, maka "With Cash Advance" dicentang.</i></span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row mt-5" id="rows_table_cash_advance">
            ...
            <div class="col-xl-12">
              <div class="tab-content">
                <!-- Cash Advance -->
                <div class="tab-note-box" style="display:none;">
                  <i>Note :</i>
                  <i>
                    Jika tanggal Transport/Accommodation/Cash Advance masih digunakan maka kolom Action <b>"Tidak Dicentang"</b>.
                  </i>
                </div>
                <div class="tab-pane" id="tab-pane-1">
                  ...
                  <div class="container-fluid row mb-3 pt-1">
                    <div class="col-md-3">
                      <div class="row ml-1">
                        <label for="currency_cashadvance">Currency</label>
                      </div>
                      <select name="currency_cashadvance" id="currency_cashadvance" class="currency-cash-advance form-control form-control-sm"></select>
                    </div>
                    <div class="col-md-2">
                      <div class="row ml-1">
                        <label for="currencyrate_cashadvance">Currency Rate</label>
                      </div>
                      <input name="currencyrate_cashadvance" id="currencyrate_cashadvance" class="currencyrate-cash-advance form-control form-control-sm">
                    </div>
                  </div>
                  ...
                  <table class="table table-hover table-bordered table-striped responsive-table" style="width:1300px">
                    <thead>
                     <tr>
                      <th>No. </th>
                      <th>Category</th>
                      <th style="width:200px;">From and To Date</th>
...
<div style="display:none;">
  <table id="sample_table_cash_advance">
    <tr id="">
      ...
      <td data-label="Category" class="offtrav-responsive-input-width">
      ...
      <td data-label="Start and End Date" class="offtrav-responsive-input-width">
      ...
      <td data-label="Region Destination" class="offtrav-responsive-input-width">
      ...
      <td data-label="Branch Destination" class="offtrav-responsive-input-width">
      ...
      <td data-label="Quantity" class="offtrav-responsive-input-width">
      ...
      <td data-label="Max Budget" class="offtrav-responsive-input-width">
      ...
      <td data-label="Total" class="offtrav-responsive-input-width">
      ...
      <td data-label="Notes" class="offtrav-responsive-input-width">
      ...
      <td data-label="Action" class="offtrav-responsive-input-width">
        <center>
			<input type="hidden" class="re_disabled_input" name="cashadvance[0][re_disabled]" id="cashadvance_0_re_disabled">
			<div align="center" class="dis_cashadvance" style="display:none;">
				<input type="checkbox" class="text mt-2 check_cashadvance_input" style="width: 20px;height: 20px;accent-color:#423f3f;" name="cashadvance[0][check_cashadvance]" id="cashadvance_0_check_cashadvance"><br>
				Inactive
			</div>
      ...
      <td data-label="Status">
        <div class="cashadvance_status"></div>
      </td>
    </tr>
  </table>
</div>
...
<div style="display:none;">
  <table id="sample_table_transport">
    <tr id="">
      ...
      <td data-label="Transport Recommendation" class="offtrav-responsive-input-width">
      ...
      <td data-label="From" class="offtrav-responsive-input-width">
        <div class="row">
          <div class="col-lg-12">
      ...
      <td data-label="To" class="offtrav-responsive-input-width">
        <div class="row">
          <div class="col-lg-12">
      ...
      <td data-label="Destination Branch" class="offtrav-responsive-input-width">
        <div class="row">
          <div class="col-lg-12">
      ...
      <td data-label="Date" class="offtrav-responsive-input-width">
        <div class="input-group">
          <input type="text" readonly="readonly" autocomplete="off" name="transport[0][date_transport]" id="transport_0_date_transport" class="form-control form-control-sm date_transport_input " style="width:100%;background-color:#fff;">
      ...
      <td data-label="Time" class="offtrav-responsive-input-width">
        <input autocomplete="off" readonly="readonly" name="transport[0][time_transport]" id="transport_0_time_transport" class="form-control form-control-sm time_transport_input" style="width:100%;background-color:#fff;">
      ...
      <td data-label="Action" class="offtrav-responsive-input-width">
        <center>
			<input type="hidden" class="trans_disabled_input" name="transport[0][trans_disabled]" id="transport_0_trans_disabled">
			<div align="center" class="dis_transport" style="display:none;">
				<input type="checkbox" class="text mt-2 check_trans_input" style="width: 20px;height: 20px;accent-color:#423f3f;" name="transport[0][check_trans]" id="transport_0_check_trans"><br>
				Inactive
			</div>
      ...
      <td data-label="Status">
        <div class="transport_status"></div>
      </td>
    </tr>
  </table>
</div>
...
<div style="display:none;">
  <table id="sample_table_akomodasi">
    <tr id="">
      ...
      <td data-label="Name of Hotel/Kos" class="offtrav-responsive-input-width">
	   ...
	   <td data-label="City" class="offtrav-responsive-input-width">
        <div class="row">
          <div class="col-lg-12">
      ...
      <td data-label="Check In and Check Out Date" class="offtrav-responsive-input-width">
      ...
      <td data-label="Length of stay" class="offtrav-responsive-input-width">
     ...
     <!--  <td>
      ...
      <td data-label="Action" class="offtrav-responsive-input-width">
        <center>
			<input type="hidden" class="akomodasi_disabled_input" name="akomodasi[0][akomodasi_disabled]" id="akomodasi_0_akomodasi_disabled">
			<div align="center" class="dis_akomodasi" style="display:none;">
				<input type="checkbox" class="text mt-2 check_akomodasi_input" style="width: 20px;height: 20px;accent-color:#423f3f;" name="akomodasi[0][check_akomodasi]" id="akomodasi_0_check_akomodasi"><br>
				Inactive
			</div>
      ...
      <td data-label="Status">
        <div class="akomodasi_status"></div>
      </td>
    </tr>
  </table>
</div>
...
<div id="browseApprovalModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              <h4 class="modal-title-delete">Browse Approval</h2>
          ...
          <div class="modal-body">
            <div class="">
              <div class="row">
                ...
                <div class="col-sm-8">
                  <select id="browse_approval_company" name="browse_approval_company" action="department" class="form-control form-control-sm select_company browse-approval-input" style="width: 100%;">
                    <option></option>
                  </select>
                  <span class="invalid-feedback" role="alert" id="browse_approval_companyError">
                    <strong></strong>
                  </span>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-sm-8">
                  <select id="browse_approval_department" name="browse_approval_department" action="position_routing" class="form-control form-control-sm select_department browse-approval-input" style="width: 100%;">
                    <option></option>
                  </select>
                  <span class="invalid-feedback" role="alert" id="browse_approval_departmentError">
                    <strong></strong>
                  </span>
                </div>
              </div>
              <div class="row">
                <label class="col-sm-4 col-form-label">Position Routing</label>
                <div class="col-sm-8">
                  <select id="browse_approval_position_routing" name="browse_approval_position_routing" action="employee" class="form-control form-control-sm select_position_routing browse-approval-input" style="width: 100%;">
                    <option></option>
                  </select>
                  <span class="invalid-feedback" role="alert" id="browse_approval_position_routingError">
                    <strong></strong>
                  </span>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-sm-8">
                  <select id="browse_approval_employee" name="browse_approval_employee" action="" class="form-control form-control-sm select_employee browse-approval-input" style="width: 100%;">
                    <option></option>
                  </select>
                  <span class="invalid-feedback" role="alert" id="browse_approval_employeeError">
                    <strong></strong>
                  </span>
                </div>
              </div>
          ...
          <div class="modal-footer">
            <button type="button" name="approval_ok_button" id="approval_ok_button" class="btn btn-success" disabled>OK</button>
...
<style>
  @media(max-width: 1279px) {
    .offtrav-responsive-input-width {
...
let global_code_travel = "";
let global_currency = [];
let global_company = null;
let global_loading_queue_count = 0;
...
document.onkeydown = (e) => {
  ...
  function hide_loading() {
    global_loading_queue_count--;
    if(global_loading_queue_count > 0) return;
  ...
  var global_default_approved_by = null;
  function get_data(){
    $.ajax({
      method: "GET",
      url : "{{url('cash_advance/official_travel/official_travel/get_data')}}",
      success: function (response) {
        if(response.user.length == 0 && buttonType == "New") {
          swal({
            icon: "error",
            title: "Error",
            text: "You are not allowed to create Official Travel in this company!"
          })
          .then(() => {
            $('.modal').modal("hide");
          });
        ...
        if (response.travel_type.length > 0) {
          $("#id_reason_group").select2({
            ...
            data: response.travel_type.map(function(item) {
              return { id: item.id_general_data, text: item.description, code_travel: item.code_travel };
            })
          });
        }
        if (response.user.length > 0) {
        // hide_loading();
        global_currency = response.currency;
        global_company = response.company;
        ...
        $('#currency_cashadvance').select2({
          data: global_currency
        }).val(response.company.id_currency).trigger('change');
   ...
   $.ajax({
    ...
    success: function (response) {
      ...
      if (response.count_by > 0) {
        ...
        global_default_approved_by = response.approval_by;
...
// var formattedDate = today.getFullYear() + '-' + (today.getMonth() + 1) + '-' + today.getDate().toString().padStart(2, '0');
 var formattedToday = "{{ date('Y-m-d') }}";//today.toISOString().split('T')[0];
...
function check_max_date_cashadvance(start_date, request_by) {
	  $.ajax({
		...
		//    if (job_class_group == 'gm-level' || position_routing == 'INTERNAL AUDIT SUPERVISOR' || position_routing == 'INTERNAL AUDIT COORDINATOR' || position_routing == 'INTERNAL AUDIT STAFF') {
			if (jQuery.inArray(position_routing, cek_pos_routing) !== -1) {
        ...
        $("#with_caseadvance").attr('disabled', false);
			  // $("#with_trans").attr('disabled', false);
			  // $("#with_accom").attr('disabled', false);
        
			}
			else{
				if(global_code_travel == 'Mutation'){	
					if (max_days < 2) {
    ...
    checkCashAdvanceAvailable(response[0].clearance_cash_advance_allowed);
	  },
	  error: function(response) {
...
$(document).on('change', '#id_reason_group', function (event, istrigger) {  
...
//	console.log(istrigger);
    if(!istrigger){
		...
		if($(this).select2('data').length > 0){
			...
			show_loading();
			global_code_travel = $(this).select2('data')[0].code_travel;
		}
    if($('#id_reason_group').select2('data').length > 0 && $('#id_reason_group').select2('data')[0].text == "Project") {
      $('#id_approval_request').val("").trigger('change');
      $('#id_approval_request').empty();
      if(buttonType != "New") {
        $('.browse-approval span').removeClass('bg-success btn-success');
        $('.browse-approval').css('cursor', 'not-allowed');
        $('.browse-approval').css('display', 'none');
        $('.id_approval_request_group').removeClass('input-group');
        $('.select_opsi').css('width', '100%');
        getProjectApprovalData("approved_by");
      } else {
        $('.browse-approval span').addClass('bg-success btn-success');
        $('.browse-approval').css('cursor', 'pointer');
        $('.browse-approval').css('display', '');
        $('.id_approval_request_group').addClass('input-group');
      }
      
    } else if(global_default_approved_by) {
      $('.browse-approval span').removeClass('bg-success btn-success');
      $('.browse-approval').css('cursor', 'not-allowed');
      $('.id_approval_request_group').removeClass('input-group');
      $('.browse-approval').css('display', 'none');
      $('.select_opsi').css('width', '100%');
      $('#id_approval_request').select2({
        data: global_default_approved_by
      });
      $('#id_approval_request').val(global_default_approved_by[0].id).trigger('change');
    }
		hide_loading();
	}
});

$('.browse-approval').on('click', function() {
  if($('#id_reason_group').select2('data').length == 0 || $('#id_reason_group').select2('data')[0].text != "Project" || buttonType != "New") return;
  $('#browseApprovalModal').modal('show');
})
  ...
  if (startDate) {
	if(buttonType != 'reschedule'){  
		...
		$('#table_cash_advance tr').each(function (index) {
			disabledType = $(this).find('.tanggal_input').attr('readonly');
			if(disabledType != 'readonly'){
				$(this).find('.tanggal_input').val('');
				$(this).find('.delete-record').trigger('click')
			}
		});
		$('#table_transport tr').each(function (index) {
			disabledType = $(this).find('.date_transport_input').attr('readonly');
			if(disabledType != 'readonly'){
				$(this).find('.date_transport_input').val('');
				$(this).find('.delete-record-trans').trigger('click')
			}
		});
		$('#table_accommodation  tr').each(function (index) {
			disabledType = $(this).find('.start_end_akomodasi_input').attr('readonly');
			if(disabledType != 'readonly'){
				$(this).find('.start_end_akomodasi_input').val('');
				$(this).find('.delete-record-akomo').trigger('click')
			}
		});
	}
  }  
...
//    $("#label_button_action").html('Save as Draft');
    ...
    $("#letter_date").val(formattedToday);
...
//	input_max_budget(element,size);
    ...
    element.find('.delete-record').css('display', 'block');
...
$(document).on('click', '.delete-record', function () {
  ...
  $(document).on('click', '#new_transport', function () {
    ...
    element.find('.delete-record-trans').css('display', 'block');
...
$(document).on('click', '.delete-record-trans', function () {
  ...
  return true;
    ...
    $(document).on('click', '#new_accommodation', function () {
      ...
      element.find('.delete-record-akomo').css('display', 'block');
...
$(function () {
  let bankAccountName = '{{@$bankAccount->account_name ?? "-"}}';
  let bankAccountNumber = '{{@$bankAccount->bank_account ?? "-"}}';
  let bank = '{{@$bankAccount->bank_name ?? "-"}}';
  $('#travelForm').submit(function (e) {
    ...
    warn.innerHTML = `Nama dan nomor rekening bank anda di HRIS anda adalah:
                      <div style="text-align:left;" class="px-3 my-3">
                        <div class="row">
                          <div class="col-4">Bank</div>
                          <div class="col">: <b>${bank}</b></div>
                        </div>
                        <div class="row">
                          <div class="col-4">No. Rekening</div>
                          <div class="col">: <b>${bankAccountNumber}</b></div>
                        </div>
                        <div class="row">
                          <div class="col-4">Nama</div>
                          <div class="col">: <b>${bankAccountName}</b></div>
                        </div>
                      </div>
                      Jika ada perbedaan nama dan nomor rekening, silakan menghubungi HRBP.`;
    swal({
      icon: 'warning',
      ...
      if(confirm) {
        ...
        //    document.querySelector(".action").disabled=false;
            if (response.status === 422) {
              ...
              if(key_temp == "id_approval_request") {
                $('.id_approval_request_group').addClass('is-invalid');
              }
    ...
    //      $("#start_end").attr('disabled',true);
          ...
          $("#id_position_routing").select2({
                data: response.data.map(function(item) {
                  return { id: id_position_detail, text: item.position_detail };
                })
          });
          $("#letter_date").attr('disabled',true);
        ...
        if (response.cashadvance) {
          $.each(response.cashadvance, function (i, item) {
            $('#currency_cashadvance').val(response.cashadvance[0].id_currency_cash_advance);
            $('#currencyrate_cashadvance').val(response.cashadvance[0].currency_rate_cash_advance);
        ...
        $('#reason_notes').attr('disabled', false);
			  }
            });                       
          }, 200);
        }
        ...
        if (response.transport) {
         ...
         //   $("#id_cashadvance_trans").val(response.transport[0].id_cash_advance);
          ...
          //    var branch = notes_trans[3];
			  ...
			  if(response.data[0].status_approval != 'Revised'){
...
function getProjectApprovalData(action) {
  let data = { action };
  if(action == "department") data.id_company = $('#browse_approval_company').val();
  else if(action == "position_routing") data.id_department = $('#browse_approval_department').val();
  else if(action == "employee") data.id_position_routing = $('#browse_approval_position_routing').val();
  else if(action == "approved_by") data.id_official_travel = $('#id_official_travel').val();
  else if(!action || action == "") return;

  $.ajax({
    url: "{{ route('offtrave.get_project_approval') }}",
    data,
    beforeSend: () => {
      $('.browse-approval-input').attr('disabled', true);
    },
    success: (response) => {
      if(action == "company") {
        $('#browse_approval_company').empty();
        $('#browse_approval_department').empty();
        $('#browse_approval_position_routing').empty();
        $('#browse_approval_employee').empty();
        $('#browse_approval_company').prepend('<option selected></option>').select2({
          data: response,
          placeholder: "Select Company",
          allowClear: true
        })
        // $('#browse_approval_company').val("").trigger('change');
      } else if(action == "department") {
        $('#browse_approval_department').empty();
        $('#browse_approval_position_routing').empty();
        $('#browse_approval_employee').empty();
        $('#browse_approval_department').prepend('<option selected></option>').select2({
          data: response,
          placeholder: "Select Department",
          allowClear: true
        })
      } else if(action == "position_routing") {
        $('#browse_approval_position_routing').empty();
        $('#browse_approval_employee').empty();
        $('#browse_approval_position_routing').prepend('<option selected></option>').select2({
        ...
        $('#browse_approval_employee').empty();
        $('#browse_approval_employee').prepend('<option selected></option>').select2({
          data: response,
        ...
        $('#id_approval_request').val(response[0].id).trigger('change');
      }
    },
    complete: () => {
      $('.browse-approval-input').attr('disabled', false);
    },
  })
}

$(document).ready(function() {
  getProjectApprovalData("company");
})

$('.browse-approval-input').on('change', function() {
  getProjectApprovalData($(this).attr('action'));
  if($('#browse_approval_employee').val() != "") {
    $('#approval_ok_button').attr('disabled', false);
  } else {
    $('#approval_ok_button').attr('disabled', true);
  }
});

$('#approval_ok_button').on('click', function () {
  $("#id_approval_request").empty();
  let options = $('#browse_approval_employee').select2('data');
  if(options) {
  ...
  $('#browseApprovalModal').modal('hide');
});
...
*/
$(document).on('change', '#currency_cashadvance', function () {
  if($('#currency_cashadvance').val() == global_company.id_currency) {
    $('#currencyrate_cashadvance').val(1).attr('readonly', true);
  } else {
    $('#currencyrate_cashadvance').attr('readonly', false);
  }
})
...
function checkCashAdvanceAvailable(allow) {
  if(!allow) {
    $('#with_caseadvance').attr('disabled', true);
  } else {
    $('#with_caseadvance').attr('disabled', false);
