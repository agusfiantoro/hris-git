...
Dear, {{$param['content_title']}}
 ...
 telah selesai dilakukan <i>Final Approval</i> oleh <i>Approver</i> tetapi <b>sistem
 gagal untuk membuat sales code</b>. Mohon hubungi HR untuk dilakukan pengecekan.<br>
 </div>
