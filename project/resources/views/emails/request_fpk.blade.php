...
Dear, Bpk/Ibu {{$param['content_title']}}
 ...
 Dengan ini kami beritahukan bahwa ada sebuah permohonan <b>Permintaan Karyawan (FPK)</b> yang dibuat di dalam aplikasi HRIS menunggu Approval dari Anda. <br>
...
<table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="padding-top:10px;font-size:14px;">
 ...
 @component('mail::panel')
	...
	<table width="100%" cellpadding="0" cellspacing="0" role="presentation"  style="font-size:14px;">
		<tr>
			<td style="width:150px;display:inline-block;"><b>Request Position</b></td>
			<td style="display:inline-block;"><b>:</b></td>
			<td style="display:inline-block;">{{ $param['pos_req'] }}</td>
		</tr>
		<tr>
			<td style="width:150px;display:inline-block;"><b>Request Total</b></td>
			<td style="display:inline-block;"><b>:</b></td>
			<td style="display:inline-block;">{{ $param['count_req'] }}</td>
		</tr>
		<tr>
