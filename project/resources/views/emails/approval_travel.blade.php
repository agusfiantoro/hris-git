...
Dear, {{$param['content_title']}}
 ...
 Dengan ini kami beritahukan bahwa <i><b>Request Official Travel</b></i> anda dengan 
 No. {{ $param['reference_number'] }} telah selesai dilakukan <i>Final Approval</i> oleh <i>Approver</i>.<br>
 </div>
 @component('mail::panel')
	{{ $param['permohonan'] }}
	<table width="100%" cellpadding="0" cellspacing="0" role="presentation"  style="font-size:14px;">
		<tr>
			<td style="width:150px;display:inline-block;"><b>Request Start Date</b></td>
			<td style="display:inline-block;"><b>:</b></td>
			<td style="display:inline-block;">{{ $param['from_date'] }}</td>
		</tr>
		<tr>
			<td style="width:150px;display:inline-block;"><b>Request End Date</b></td>
			<td style="display:inline-block;"><b>:</b></td>
		...
		<tr>
			<td style="width:150px;display:inline-block;"><b>Status Official Travel</b></td>
			<td style="display:inline-block;"><b>:</b></td>
			<td style="display:inline-block;">{{ $param['travel_status'] }}</td>
		</tr>
	</table>
	@endcomponent
<div style="font-size:14px;">
