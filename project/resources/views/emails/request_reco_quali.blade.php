...
Dear, Bpk/Ibu {{$param['content_title']}}
 ...
 Dengan ini kami beritahukan bahwa ada sebuah permohonan <b>Penilaian 360 Feedback (RECO)</b> yang dibuat di dalam aplikasi HRIS menunggu Penilaian dari Anda. <br>
...
<table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="padding-top:10px;font-size:14px;">
 ...
 @component('mail::panel')
	...
	<table width="100%" cellpadding="0" cellspacing="0" role="presentation"  style="font-size:14px;">
		...
		<tr>
			<td style="width:150px;display:inline-block;"><b>Position</b></td>
			<td style="display:inline-block;"><b>:</b></td>
			<td style="display:inline-block;">{{ $param['position'] }}</td>
		</tr>
		<tr>
			<td style="width:150px;display:inline-block;"><b>Category (Type)</b></td>
			<td style="display:inline-block;"><b>:</b></td>
			<td style="display:inline-block;">{{ $param['code'] }}</td>
		</tr>
		<tr>
			<td style="width:150px;display:inline-block;"><b>Notes</b></td>
			<td style="display:inline-block;"><b>:</b></td>
			<td style="display:inline-block;">Tipe Penilaian Anda adalah <b>{{ $param['note'] }}</b></td>
		</tr>
	</table>
	@endcomponent
<div style="font-size:14px;">
Silahkan masuk ke aplikasi my.borwita.co.id untuk proses Approval.
</div>
<br>
