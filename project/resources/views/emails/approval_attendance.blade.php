...
Dear, {{$param['content_title']}}
 ...
 Dengan ini kami beritahukan bahwa <i>Request</i> anda dengan 
 No. {{ $param['reference_number'] }} telah selesai dilakukan <i>Final Approval</i> oleh semua <i>Approver</i>.<br>
 </div>
