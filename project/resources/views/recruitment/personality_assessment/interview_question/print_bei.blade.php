            ...
            <table class="">
                ...
                <tbody style="width:100%">
                    ...
                    <tr class="">
                        ...
                        @foreach($interview['detail'] as $data)
                            <?php $ansText = $data->answer ?? $data->essay_answer; ?>
                            @if($ansText)
                                <tr class="">
                                    <td style="width:210px" class="border px-2 py-1">{{$data->question}}</td>
                                    <td style="width:470px" class="border rounded px-2 py-1"><i>{!! $ansText ?? '<span class="text-danger">No answer</span>' !!}</i></td>
                                </tr>
                            @endif
                        @endforeach
                        <tr>
                            ...
                            <td class="borderless">
                                {!! trim($interview['int_notes'], " \n") !!}
                                {{-- <textarea name="" id="" cols="30" rows="10" style="border:0px;">
