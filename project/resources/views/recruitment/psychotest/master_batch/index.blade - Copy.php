			    ...
			    <div style="display:none;">
					<table id="sample_table_rec">
						<tr id="">
							...
							<td>
								 <select name="participant[0][status]" id="participant_0_status" class="form-control form-control-sm select2 status_input" style="width: 100%;">
                                        <option value="A">Active</option>
                                        <option value="I">Inactive</option>
                                    </select>
							</td>
						<td>
						<center>
							<button type="button" class="info-record btn btn-xs btn-success" title="Info" style="display:none;"><span class="fa fa-info-circle fa-lg"></span></button>
...
<div class="modal fade" id="modal_info"  data-backdrop="static" data-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-md-12">
							<div class="row">
                                ...
                                <div class="col-sm-9">
									<input id="can_emp_email" type="text" class="form-control form-control-sm">	
                                </div>
                            </div>
							<div class="row">
                                <label class="col-sm-3 col-form-label">Mobile Phone</label>
                                <div class="col-sm-9">
									<input id="can_emp_phone" type="text" class="form-control form-control-sm">	
                                </div>
                            </div>
						</div> 						
                    </div>				
...
$(function () {	
	...
	$(document).on('click', '.new', function () {
									...
									setTimeout(function () {
										$('#table_rec_body tr').each(function (index) {		
											...
											if(response.participant[index].source_type == 'Internal'){
												$(this).find('.info-record').attr('id', response.participant[index].id_employee).attr('id_source_type','Internal');
												...
												$(this).find('.info-record').attr('id', response.participant[index].id_candidate).attr('id_source_type','External');
        ...
        //    element.find('.info-record').attr('data-info', size);
	...
	$(document).on('click', '.info-record', function (event) {
		id_can_emp = $(this).attr('id');
        let id_source_type = $(this).attr('id_source_type');
		
		$('#modal_info').modal('show');
		$("#modal_info").css("background","white");
		$("#modal_info").css("color","black");
	//	console.log(id_can_emp);
	//	console.log(id_source_type);
	});	
