    ...
    <div class="col-12">
        ...
        <div class="card card-danger card-outline">
            <div class="card-header">
                <h5 class="card-title">DISC Summary</h5>               
            </div>      
			<div class="card-body">
...
$("#table_div_emp").html('<table id="employee_table" style="width:100%;" class="table table-striped table-bordered table-hover datatable"></table>');
	...
	let t_emp = $('#employee_table').DataTable({
		...
		columns: [
			...
			{ data: 'character', title: 'DISC Profile', className: 'text-score th-text-score', render: function ( data, type, row ) {
					return '<span class="badge badge-success" style="padding:5px;font-size:16px;">'+data+'</span>';
				}
			},
