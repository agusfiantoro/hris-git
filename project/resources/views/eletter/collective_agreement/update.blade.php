<div class="modal fade" id="modal_form_pb_edit"  data-backdrop="static" data-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <form method="POST" id="pbFormEdit" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                           <div class="row">
                            ...
                            <div class="col-sm-8">
                                <select id="id_category_edit" name="id_category" class="form-control form-control-sm select_opsi" style="width: 100%;">
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <select id="remark_1_edit" name="remark_1" class="form-control form-control-sm select_search_edit" style="width: 100%;" readonly>
                                </select>
                        ...
                        <div class="row">
                            <label class="col-sm-4 col-form-label">Name <span id="validate_byname_edit"></span></label>
                            <div class="col-sm-8">
                               <div class="input-group">
                                <select id="id_employee_edit" name="id_employee" class="form-control-sm select_search_edit" style="width: 88%;" readonly>
                                </select>
                                <div class="input-group-append">
                                    <button disabled="" type="button" class="input-group-text btn-sm btn bg-success btn-success text-white"><i class="far fa-list-alt"></i></button>
                                </div>
                            </div>
            ...
            <div class="col-md-6">
              <div class="row">
                ...
                <div class="col-sm-8">
                    <select id="id_position_detail_edit" name="id_position_routing" class="form-control form-control-sm select_search_edit" style="width: 100%;" readonly>
                    </select>
                    <span class="invalid-feedback d-block" role="alert" id="id_position_routing_editError">
                        <strong></strong>
                    </span>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-sm-8">
                    <select id="id_dept_edit" name="id_dept" class="form-control form-control-sm select_search_edit" style="width: 100%;" readonly>
                    </select>
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <select id="id_branch_edit" name="id_branch" class="form-control form-control-sm select_search_edit" style="width: 100%;" readonly>
                    </select>
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <select id="id_region_edit" name="id_region" class="form-control form-control-sm select_search_edit" style="width: 100%;" readonly>
                    </select>
