<div class="modal fade" id="modal_form_imm"  data-backdrop="static" data-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <form method="POST" id="immForm" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <select id="id_dept" name="id_dept" class="form-control form-control-sm select_search" style="width: 100%;">
                                    </select>
                        ...
                        <div class="col-md-6">
                          <div class="row">
                            ...
                            <div class="col-sm-8">
                                <select id="id_region" name="id_region" class="form-control form-control-sm select_search" style="width: 100%;">
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <select id="id_branch" name="id_branch" class="form-control form-control-sm select_search" style="width: 100%;">
                                </select>
                       ...
                       <!--  <div class="row">
                            ...
                            <div class="col-sm-8">
                             <select id="id_employee_chief" name="id_employee_chief" class="form-control form-control-sm select_search" style="width: 100%;">
                             </select>
