    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <span id="nik_view" class="view"></span>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <span id="mengetahui_view" class="view"></span>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        <label id="">Jabatan Mengetahui</label>
                    </div>
                </div>
                <div class="col-lg-1">
                    <div class="form-group">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <span id="jabatan_mengetahui_view" class="view"></span>
                    </div>
                </div>
            </div>
        </div>
