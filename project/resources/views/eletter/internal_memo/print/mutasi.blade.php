	...
	<!-- <div class="container"> -->
		...
		<div class="row">
			<table style="width: 100%;" cellpadding="4" cellspacing="0">
				<tbody>
					...
					<tr style="border: 1px solid;">
						<td>Subject</td>
						<td>:</td>
						<td>Pemberitahuan Mutasi Sdr/i. {{$data->name}}</td>
					</tr>
				</tbody>
			</table>
			<p>
			...
			<p>
				...
				sampaikan pemberitahuan tugas dari User untuk melaksanakan mutasi jabatan sebagai berikut :
			</p>
			...
			<p>
				<br>
				Untuk keberhasilan mutasi Saudara, maka perlu :
				<ol>
					<li>Melakukan intensive coaching dengan User dan PIC yang terkait dengan Job Description / Accountability.</li>
					<li>Melaksanakan Job Assignment yang sudah ditargetkan oleh User.</li>
				</ol>
