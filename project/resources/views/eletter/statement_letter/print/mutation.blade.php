		...
		<div class="row">
			<table style="width: 100%;">
				<tr>
					...
					<td>:</td>
					<td>&nbsp;Formulir Persetujuan Mutasi tanggal {{tgl_indo($data->date)}}</td>
				</tr>
				<tr>
					<td>MENIMBANG</td>
					<td>:</td>
					<td>
						&nbsp;1. Adanya Formasi kerja / jabatan di bagian {{$data->dec_position_new}}
					</td>
				</tr>
				<tr>
					<td></td>
					<td></td>
					<td>
						&nbsp;2. Optimalisasi alokasi sumber daya manusia
					</td>
				</tr>
				<tr>
					<td></td>
					...
					<td>
						&nbsp;1. Saudara yang tersebut dibawah ini :
								<table style="width: 90%; margin-left:24px;">
									...
									<tr>
										<td colspan="4">Terhitung mulai tanggal {{tgl_indo($data->effective_date)}} dimutasikan ke :</td>
									</tr>
									<tr>
										<td>a.</td>
										<td>Jabatan</td>
