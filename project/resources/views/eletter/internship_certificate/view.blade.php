    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <span id="remark_1_view" class="view"></span>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <span id="remark_3_view" class="view"></span>
                    </div>
                </div>
                <!--  -->
                <div class="col-lg-4">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <span id="remark_4_view" class="view"></span>
                    </div>
                </div>
               <!--  <div class="col-lg-4">
                    <div class="form-group">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <span id="effective_date_view" class="view"></span>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <span id="expired_date_view" class="view"></span>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        <label id="">Email Atasan</label>
                    </div>
                </div>
                <div class="col-lg-1">
                    <div class="form-group">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <span id="name_chief_view" class="view"></span>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                ...
                <div class="col-lg-7">
                    <div class="form-group">
                        <span id="position_chief_view" class="view"></span>
                    </div>
                </div>
            </div>
        </div>
