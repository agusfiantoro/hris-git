<script type="text/javascript">
        ...
        success: function(response) {
          if (response) {
            $.each(response, function(key, value) {
              ...
              $("#id_category_edit").append('<option value="' + value.category + '">'+ value.category +'</option>');
  ...
  $(document).on('click', '.btn-edit', function() {
    ...
    $("#spFormEdit input").removeClass("is-invalid");
    $("#spFormEdit select").removeClass("custom-select");
    $("#spFormEdit textarea").removeClass("is-invalid");
    $("#modal_form_sp_edit").modal('show');
    if (id_letter) {
      get_edit(id_letter);
    }
  });
