...
@section('title', 'Warning Letter (SP1 & SP2)')
  ...
  <div class="col-12">
    ...
    <div class="card card-danger card-outline">
      <div class="card-header">
        <h5 class="card-title">Warning Letter (SP1 & SP2)</h5>
        <div class="card-tools">
          <button type="button" class="new btn btn-sm btn-success"><i class="fas fa-plus"></i> Add SP1 & SP2</button>
        </div>
      </div>
      <div class="card-body">
        ...
        <br>
        <br>
        <table id="sp_table" style="width: 100%;" class="table table-striped table-bordered table-hover datatable">
          <thead>
           <tr>
            <th></th>
            <th></th>
...
@endsection
@include('eletter/warning_letter/create')
@include('eletter/warning_letter/update')
...
@section('scripts')
@include('eletter/warning_letter/js/js-create')
@include('eletter/warning_letter/js/js-update')
<script type="text/javascript">
  ...
  function get_data() {
    $.getJSON("{{ url('e-letter/company_letter/warning_letter/get_data') }}", function(response) {
