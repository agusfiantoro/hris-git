<div class="modal fade" id="modal_form_skp"  data-backdrop="static" data-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <form method="POST" id="skpForm" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <select id="id_employee" name="id_employee" class="form-control-sm select_opsi" style="width: 100%;">
                                </select>
