<div class="modal fade" id="modal_form_pkk"  data-backdrop="static" data-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <form method="POST" id="pkkForm">
                {{ csrf_field() }}
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <input type="checkbox" style="width: 20px;height: 20px;" name="remark_2" value="Rehire" id="remark_2">
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8" id="employee_notrehire">
                            ...
                            <div class="col-sm-8" id="employee_rehire" style="display: none;">
                                <select id="id_employee" name="id_employee" class="form-control form-control-sm select_search" style="width: 100%;">
                                </select>
                                <input type="hidden" id="nama_employee" hidden="" name="nama_employee">
                        ...
                        <div class="row">
                            <label class="col-sm-4 col-form-label"> <span id="date_end">Expired</span> Date <span id="validate_category"></span></label>
                            <div class="col-sm-8">
                    ...
                    <div class="col-md-6">
                       <div class="row">
                        ...
                        <div class="col-sm-8">
                            <select name="id_position_detail" id="id_position_detail" class="form-control form-control-sm select_rehire" style="width: 100%;">
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <select name="id_dept" id="id_dept" class="form-control form-control-sm select_disabled select_rehire" style="width: 100%;" readonly>
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <select name="id_job_grade" id="id_job_grade" class="form-control form-control-sm select_disabled select_rehire" style="width: 100%;" readonly>
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <select name="id_branch" id="id_branch" class="form-control form-control-sm select_search select_rehire" style="width: 100%;">
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <select name="id_location" id="id_location" class="form-control form-control-sm select_search select_rehire" style="width: 100%;">
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <select name="id_region" id="id_region" class="form-control form-control-sm select_disabled select_rehire" style="width: 100%;" readonly>
                            </select>
