        ...
        <div class="card card-danger card-outline">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <button type="button" class="new btn btn-sm btn-success"><i class="fas fa-plus"></i> Add Program</button>
                </div>
            </div>
        ...
        <div class="modal-content">
            <form method="post" id="eventForm" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row" id="modal_form_header">						
						<div class="col-md-6">
							<div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <select name="region" id="region" class="form-control form-control-sm select2" style="width: 100%;">
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <select name="branch" id="branch" class="form-control form-control-sm select2" style="width: 100%;">
                                    </select>
						...
						<div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <select name="managed_by[]" id="managed_by" class="form-control form-control-sm select2" multiple="multiple" style="width: 100%;">
                                    </select>
                                    <span class="invalid-feedback" role="alert" id="managed_byError">
                                        <strong></strong>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-form-label">Mandatory Program</label>
                                <div class="col-sm-8">
                                    <input type="checkbox" name="mandatory" id="mandatory" class="form-control form-control-sm" style="height:20px;width:20px;margin-top:5px;">
                                    <span class="invalid-feedback" role="alert" id="mandatoryError">
                                        <strong></strong>
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="row tab">
			            ...
			            <hr/>
                            <ul class="nav nav-tabs" id="tab_menu_detail" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="link_tab_event_program" data-toggle="tab" href="#tab_event_program" role="tab" aria-controls="link_tab_event_program" aria-selected="true">Course<span class="error-tab text-red"></span></a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="tab-pane fade active show" id="tab_event_program" role="tabpanel" aria-labelledby="custom-content-below-home-tab">
                                    ...
                                    <div class="row justify-content-end">
                                        <div class=pull-right" style="margin-bottom: 10px">
                                            <button type="button" class="btn btn-sm btn-primary btn-rounded mr-1" id="btn_batch_add_course"><span class="fas fa-upload"></span> Upload Course</button>
                                            <button type="button" class="pull-right btn btn-sm btn-primary btn-rounded" id="new_event"><span class="fas fa-plus"></span> Add Course</button>
                                        </div>
                                ...
                                <div class="tab-pane fade " id="tab_attendees" role="tabpanel" aria-labelledby="custom-content-below-home-tab">
                                    ...
                                    <div class="row justify-content-end">
                                        ...
                                        <div class="col-sm-2 pull-right" style="margin-bottom: 10px">
                                            <button type="button" class="pull-right btn btn-sm btn-primary btn-rounded" id="upload_attendees"><span class="fas fa-upload"></span> Upload Attendees</button>
                                        </div>
			...
			<div style="display:none;">
                <table id="sample_table_event">
                    <tr id="">
                        ...
                        <td>
                            <input name="event[0][sequence]" id="event_0_sequence" type="text" class="form-control form-control-sm sequence_input">
                            <span class="invalid-feedback sequence_input_error" role="alert" id="event_0_sequenceError">
                                <strong></strong>
                            </span>                 
                        </td>
                        <td>
                            ...
                            <select name="event[0][id_course_header]" id="event_0_id_course_header" class="form-control form-control-sm select2 id_course_header_input" style="width: 100%;">
                            </select>
                            <span class="invalid-feedback id_course_header_input_error" role="alert" id="event_0_id_course_headerError">
                                <strong></strong>
                            </span>					
                        </td>
                        <!-- <td>
                                <select name="event[0][id_checklist]" id="event_0_id_checklist" class="form-control form-control-sm select2 id_checklist_input" style="width: 100%;">
                                </select>
                                <span class="invalid-feedback id_checklist_input_error" role="alert" id="event_0_id_checklistError">
                                    <strong></strong>
                                </span>
                        </td> -->
                        <td>
                        ...
                        <td>
                            <select name="event[0][id_trainer]" id="event_0_id_trainer" class="form-control form-control-sm select2 id_trainer_input" style="width: 100%;">
                            </select>
                            <span class="invalid-feedback id_trainer_input_error" role="alert" id="event_0_id_trainerError">
                                <strong></strong>
                            </span>					
                        </td>
                        <td>
                ...
                <table id="sample_table_attendees">
                    <tr id="">
                        ...
                        <td>
                            ...
                            <select name="attendee[0][booked_by]" id="attendee_0_booked_by" class="form-control form-control-sm select2 booked_by_input" data-id="0" style="width: 200px;">
                            </select>
                        ...
                        <td>
                            ...
                            <button class="btn btn-primary btn-sm mt-1 btn-apply-all-courses" type="button">Apply All</button>
                        </td>
                        <td>
...
<div id="attendeesModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <span class="fas fa-plus"></span> Upload Attendees
                </h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <form method="post" id="attendeesForm">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            <button type="button" class="btn btn-sm btn-primary" onclick="downloadAttendeesTemplate()">Download</button>
                            <span class="invalid-feedback" role="alert" id="attendees_attachmentError">
                                <strong></strong>
                            </span>
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            {{ csrf_field() }}
                            <input type="file" name="attendees_attachment" id="attendees_attachment" class="form-control-file form-control-sm">
                            <span class="invalid-feedback" role="alert" id="attendees_attachmentError">
                                <strong></strong>
                            </span>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <select name="id_event_program" id="attendees_event_program" multiple style="width:100%"></select>
                            <span class="invalid-feedback" role="alert" id="attendees_attachmentError">
                                <strong></strong>
                            </span>
                        </div>
                        <div class="col-sm-2">
                            <button class="btn btn-primary btn-sm mt-1 btn-apply-all-courses-upload" type="button">Apply All</button>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
             <button type="button" name="import_button" id="import_button" class="btn btn-success" onclick="$('#attendeesForm').submit()">Save</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
...
<div id="batchAddCourseModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <span class="fas fa-plus"></span> Upload Course
                </h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <form method="post" id="batchAddCourse">
                    <div class="row mb-2">
                        <label class="col-sm-4 col-form-label">Template</label>
                        <div class="col-sm-8">
                            <button type="button" class="btn btn-sm btn-primary" onclick="downloadCourseTemplate()">Download</button>
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Course File</label>
                        <div class="col-sm-8">
                            {{ csrf_field() }}
                            <input type="hidden" name="id_event_management" class="id_event_management">
                            <input type="file" name="batch_course_attachment" id="batch_course_attachment" class="form-control-file form-control-sm">
                            <span class="invalid-feedback" role="alert" id="batch_course_attachmentError">
                                <strong></strong>
                            </span>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" name="course_import_button" id="course_import_button" class="btn btn-success" onclick="$('#batchAddCourse').submit()">Save</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
...
<div id="epstpModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <span class="fas fa-plus"></span> EPSTP Form
                </h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <form method="post" id="epstpForm">
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Attachment</label>
                        <div class="col-sm-8">
                            {{ csrf_field() }}
                            <input type="hidden" name="id_event_management" id="epstp_id_event_management">
                            <input type="file" name="attachment" id="epstp_attachment" class="form-control-file form-control-sm">
                            <span class="invalid-feedback" role="alert" id="epstp_attachmentError">
                                <strong></strong>
                            </span>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
             <button type="button" name="import_button" id="import_button" class="btn btn-success" onclick="$('#epstpForm').submit()">Save</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    let global_select_employee_noexp = [];
    ...
    let global_all_region = [];
    let startDateAwal;
    let endDateAwal;
    let global_permission_edit_attendees = false;
    let x = [];
    let listEmployeeHR = [];
    let status = [
        {   id: 'A',
    ...
    $(function () {	
        ...
        get_employee().then(res => {
            $('.get_employee, booked_by_input, invited_by_input, #organized_by').prepend('<option selected></option>').select2({
                ...
                allowClear: true,
                data: global_select_employee_noexp,
            });
            // $('#managed_by').select2({
            //     placeholder: "Select Employee",
            //     allowClear: true,
    ...
    function getCreateAccess() {
        $.ajax({
            url: "{{route('event_course.get_create_access')}}",
            data: {
                url: global_url_server
            },
            success: (res) => {
                if(res.can_create == false) {
                    $('.new').css('display', 'none').attr('disabled', true);
                }
            }
        })
    }
    ...
    $(document).on('click', '.new', function () {
        ...
        $("#eventForm .modal-title").html("<span class='fas fa-plus'></span> Form Program");
        $(".invalid-feedback").children("strong").text("");
        $(".table-invalid-feedback").children("strong").text("");
        $(".error-tab").html("");
        $("#eventForm input").removeClass("is-invalid");
    ...
    $(document).on('change', '#region', function () {
        $('#branch').empty().select2({
            allowClear: true,
            placeholder: 'Select Branch'
        });
        if($('#region').val() != '') {
            get_branch($('#region').val());
        }
        get_employee($('#region').val(), $('#branch').val(), true);
    });
    ...
    $(document).on('click', '#new_event', function (e, fromTrigger) {
        ...
        element.find('.start_date_input').val($('#start_date').val());
        ...
        element.find('.end_date_input').val($('#end_date').val());
        ...
        element.find('.sequence_input').attr('id', 'event_' + size + '_sequence');
        element.find('.sequence_input').attr('name', 'event[' + size + '][sequence]');
        element.find('.sequence_input_error').attr('id', 'event_' + size + '_sequenceError');
        ...
        element.find('.id_trainer_input').attr('id', 'event_' + size + '_id_trainer');
        element.find('.id_trainer_input').attr('name', 'event[' + size + '][id_trainer]');
        element.find('.id_trainer_input_error').attr('id', 'event_' + size + '_id_trainerError');
        element.find('.id_trainer_input').prepend('<option></option>').select2({
    ...
    $(document).on('click', '#new_attendees', function (e, fromTrigger) {
        ...
        if(!global_permission_edit_attendees) {
            element.find('.id_event_program_input').attr('readonly', true);
        }
    ...
    $(document).on('click', '.edit', function () {
        ...
        $('.id_event_management').val(id_event_management);
        $("#eventForm")[0].reset();
        $("#table_body_event").html("");
        $("#table_body_attendees").html("");
        $("#eventForm .modal-title").html("<span class='fas fa-edit'></span> Form Program");
        $(".invalid-feedback").children("strong").text("");
        $(".table-invalid-feedback").children("strong").text("");
        $(".error-tab").html("");
        $("#eventForm input").removeClass("is-invalid");
        ...
        $.ajax({
            url: "{{ route('event_course.get_event_edit') }}",
            method: "GET",
            ...
            success: function (res) {
                ...
                global_permission_edit_attendees = res.allow_edit_attendees;
                let current_list_employee = [];
                $.each(res.employees, function (i, val) {
                    name = `${val.name} (${val.nik_employee})`;
                    nameExp = `${val.name} (${val.nik_employee}) ${val.expired_date ? `End Contract: ${moment(val.expired_date).format('DD MMM YYYY')}`: ""}`;
                    current_list_employee.push({id:val.id_employee, text:nameExp});
                }); 
                $.each(dataEvent.attendee, function (i, val) {
                    let find = current_list_employee.findIndex((emp) => emp.id == val.booked_by);
                    if(find === -1) {
                        current_list_employee.push({id: val.booked_by, text: val.attendee_name});
                    }
                });
                ...
                if(!res.allow_edit_attendees) {
                    $('.id_event_program_input').attr('readonly', true);
                }

                if(!res.allow_edit_header) {
                    $('#modal_form_header').find('input').attr('readonly', true);
                    $('#modal_form_header').find('select').attr('readonly', true);
                    $('#modal_form_header').find('input[type=checkbox]').css('pointer-events', 'none');
                } else {
                    $('#modal_form_header').find('input').attr('readonly', false);
                    $('#modal_form_header').find('select').attr('readonly', false);
                    $('#modal_form_header').find('input[type=checkbox]').css('pointer-events', 'auto');
                }
                ...
                $('#region').val(dataEvent.id_region).trigger('change');
                $('#branch').val(dataEvent.id_branch).trigger('change');
                ...
                selectedManagedBy = dataEvent.managed_by;
                if(res.allow_save == false){
                ...
                $('#mandatory').prop('checked', dataEvent.is_mandatory_flag);
                ...
                $('#table_body_event tr').each(function (index) {
                    ...
                    $(this).find(`#event_${index}_sequence`).val(dataEvent.event[index].sequence);
                    $(this).find(`#event_${index}_id_trainer`).val(dataEvent.event[index].id_trainer).trigger('change');
                ...
                $('#table_body_attendees tr').each(function (index) {
                    ...
                    $(this).find(`#attendee_${index}_booked_by`).empty().select2({
                        allowClear: true,
                        placeholder: 'Select Employee',
                        data: current_list_employee
                    });
                ...
                if(!res.allow_add_assignment) {
                    $('#new_event').hide();
                    $('#table_body_event').find('input').attr('readonly', true);
                    $('#table_body_event').find('select').attr('readonly', true);
                    $('#table_body_event').find('a').hide();
                    $('#table_body_event').find('button').hide();
                    $('#table_body_event').find('.start_date_input').attr('data-guid', null).attr('data-datepicker', false);
                    $('#table_body_event').find('.end_date_input').attr('data-guid', null).attr('data-datepicker', false);
                }
                if(!res.allow_add_attendees) {
                    $('#new_attendees').hide();
                    $('#table_body_attendees').find('input').attr('readonly', true);
                    $('#table_body_attendees').find('select').attr('readonly', true);
                    $('#table_body_attendees').find('.status_input').hide();
                    $('#table_body_attendees').find('.btn-apply-all-courses').hide();
                    $('#table_body_attendees').find('.start_date_input').attr('data-guid', null).attr('data-datepicker', false);
                    $('#table_body_attendees').find('.end_date_input').attr('data-guid', null).attr('data-datepicker', false);
                }
    ...
    $(document).on('click', '.delete', function (event) {
        ...
        swal({
            ...
            if (value) {
                $.ajax({
                    url: "{{ route('event_course.destroy') }}",
    ...
    function save_event(counter) {
        ...
        $.ajax({
            url: "{{ route('event_course.save_event') }}",
            headers: {'X-CSRF-TOKEN': "{{ csrf_token() }}"},
            method: "POST",
            data: eventForm,
            success:function(res)
    ...
    function destroy_event_program(counter, id_event_program) {
        ...
        $.ajax({
            url: "{{ route('event_course.destroy_event') }}",
            headers: {'X-CSRF-TOKEN': "{{ csrf_token() }}"},
            method: "POST",
            data: dataSend,
            success:function(res)
    ...
    const get_employee = async (region = null, branch = null, editCall = false) => {
        try {
            $.ajax({
                url: "{{ route('event_course.get_employee_managed_by') }}",
                success: (res) => {
                    $('#managed_by').empty().prepend('<option></option>').select2({
                        placeholder: "Select Employee",
                        allowClear: true,
                        data: res
                    }).val(selectedManagedBy).trigger('change');
                }
            })
            let result;
            result = await $.ajax({
                url: '<?= url('learning_management/lms/event_course/get_employee') ?>',
                method: "GET",
                data: {
                    id_region: region,
                    id_branch: branch,
                    selected_employee: selectedManagedBy
                },
                success: function (res) {
                    if(editCall) {
                        global_select_employee = [];
                        global_select_employee_noexp = [];
                    }
                    $.each(res, function (i, val) {
                        name = `${val.name} (${val.nik_employee})`;
                        nameExp = `${val.name} (${val.nik_employee}) ${val.expired_date ? `End Contract: ${moment(val.expired_date).format('DD MMM YYYY')}`: ""}`;
                        global_select_employee.push({id:val.id_employee, text:nameExp});
                        global_select_employee_noexp.push({id:val.id_employee, text:name});
                    }); 
                    
                    // if(editCall) {
                    //     $('.booked_by_input').each(function() {
                    //         $(this).empty().prepend('<option></option>').select2({
                    //             allowClear: true,
                    //             placeholder: 'Select Employee',
                    //             data: global_select_employee
                    //         });
    ...
    const get_user_by_session = async () => {
        try {
            let result;
            result = await $.ajax({
                url: '<?= url('learning_management/lms/event_course/get_user_by_session') ?>',
                method: "GET",
                success: function (res) {
                },
            });
    ...
    const getEmployeeHR = async () => {
        try {
            let result;
            result = await $.ajax({
                url: '<?= url('learning_management/lms/event_course/getEmployeeHR') ?>',
                method: "GET",
                success: function (res) {
                    $.each(res, function (i, val) {
                        name = `${val.name} (${val.nik_employee})`;
    ...
    function get_region() {
        $.ajax({
            url: "{{ route('event_course.get_region') }}",
            method: 'GET',
            success: (res) => {
                global_all_region = res
    ...
    function get_branch(id_region) {
        $.ajax({
            url: "{{ route('event_course.get_branch') }}",
            method: 'GET',
            data: {
                id_region
            },
            success: (res) => {
                $('#branch').empty().prepend('<option></option>').select2({
                    data: res,
                    allowClear: true,
                    placeholder: 'Select Branch'
                });
    ...
    $(document).on('change', '.id_course_header_input', function() {
        global_select_course.forEach((val) => {
            if(val.id == $(this).val()) {
                $(this).parent().parent().find('.description_input').val(val.notes);
            }
        })
    });
    ...
    const get_course = async () => {
        try {
            let result;
            result = await $.ajax({
                url: '<?= url('learning_management/lms/event_course/get_course') ?>',
                method: "GET",
                success: function (res) {
                    $.each(res, function (i, val) {
                        name = `${val.course_name}`;
                        global_select_course.push({id:val.id_course_header, text:name, notes:val.notes});
                    }); 
                },
            });
            return result;
    ...
    const get_checklist = async () => {
        try {
            let result;
            result = await $.ajax({
                url: '<?= url('learning_management/lms/event_course/get_checklist') ?>',
                method: "GET",
                success: function (res) {
                    $.each(res, function (i, val) {
    ...
    $(document).on('click', '.btn-apply-all-courses', function () {
        let id = $(this).parent().find('.id_event_program_input').attr('id');
        $(`#${id} > option`).prop("selected", true).trigger('change');
    })

    $(document).on('click', '.btn-apply-all-courses-upload', function () {
        $(`#attendees_event_program > option`).prop("selected", true).trigger('change');
    })

    $(document).on('click', '#upload_attendees', function () {
        $('#attendeesModal').modal('show');
        $('#attendees_event_program').select2({
            data: global_select_program,
            allowClear: true,
    ...
    $(document).on('submit', '#attendeesForm', function(event) {
        event.preventDefault();
        // console.log($('#attendees_event_program').val());
        let formData = new FormData(this);
        formData.set('id_event_program', JSON.stringify($('#attendees_event_program').val()));
        formData.append('id_event_management', global_id_event_management);
        $.ajax({
            url: "{{ route('event_attendees.submit') }}",
            type: 'POST',
            dataType: "JSON",
            data: formData,
            processData: false,
    ...
    $(document).on('click', '.uploadEpstp', function () {
        $('#epstpModal').modal('show');
        $('#epstp_id_event_management').val($(this).attr('id-event-management'));
    });

    $(document).on('submit', '#epstpForm', function(event) {
        event.preventDefault();
        let formData = new FormData(this);
        $.ajax({
            url: "{{ route('epstp_result.submit') }}",
            type: 'POST',
            dataType: "JSON",
            data: formData,
            processData: false,
    ...
    $(document).on('click', '.duplicate-program', function() {
        let id_event_management = $(this).attr('id-event-management');
        $.ajax({
            url: "{{route('event_course.duplicate')}}",
            data: { 
                _token: '{{ csrf_token() }}',
                id_event_management 
            },
    ...
    $(document).on('submit', '#batchAddCourse', function (e) {
        e.preventDefault();
        let formData = new FormData(this);
        console.log(formData);
        $.ajax({
            url: "{{route('event_program.submit')}}",
            data: formData,
            type: 'POST',
            processData: false,
            contentType: false,
            ...
            success: (res) => {
                ...
                $('#modal_form_event').modal('hide');
                $('#batchAddCourseModal').modal('hide');
                $('#event_table').DataTable().ajax.reload();
                $('#batchAddCourse').reset();
            },
            error: (err) => {
                console.log(err)
                $('#loader').addClass('hidden');
    ...
    $(document).on('click', '#btn_batch_add_course', function () {
        $('#batchAddCourseModal').modal('show');
    })

    function downloadAttendeesTemplate() {
        window.open("{{ route('event_course.download_template') }}?template=lms.program.import_attendees", "_blank")
    }

    function downloadCourseTemplate() {
        window.open("{{ route('event_course.download_template') }}?template=lms.program.import_course_program", "_blank")
    }
