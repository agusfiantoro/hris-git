...
@section('title', 'Master Depreciation Method')
    ...
    <div class="col-12">
        <div class="card card-danger card-outline">
            <div class="card-header">
                <h5 class="card-title">Master Depreciation Method
                </h5>
                ...
                <div class="card-tools">
                    ...
                    <button type="button" more_type="New" class="new btn btn-sm btn-success"><i class="fas fa-plus"></i> Add Depreciation Method</button>
                </div>
            </div>
            <div class="card-body">
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalEditTitle">Add Depreciation Method</h5>
            </div>
            <div class="modal-body">
                <form id="depreciationMethodForm" method="post" class="row">
                    ...
                    <div class="col">
                        <div class="row mb-2">
                            <div class="col">
                                <label for="depreciation_code">Code</label>
                            </div>
                            <div class="col">
                                <input type="text" name="depreciation_code" id="depreciation_code" class="form-control form-control-sm">
                    ...
                    <div class="col">
                        <div class="row mb-2">
                            <div class="col">
                                <label for="depreciation_rule">Rule</label>
                            </div>
                            <div class="col">
                                <select name="depreciation_rule" id="depreciation_rule" class="form-control form-control-sm" style="width:100%">
                                </select>
                                <span class="error"></span>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.new', function() {
        $('#modalEditTitle').text('Add Depreciation Method');
        $('.error').text('');
    ...
    $('#depreciationMethodForm').submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: "{{ route('assets.master_depreciation_method.save') }}",
            data: $(this).serialize(),
            type: 'POST',
            beforeSend: () => {
                $('#loader').removeClass('hidden');
    ...
    $('#depreciationMethodTable').DataTable({
        responsive: true,
        ajax: {
            url: "{{route('assets.master_depreciation_method')}}"
        },
        columnDefs: [
            {
                orderable: false,
