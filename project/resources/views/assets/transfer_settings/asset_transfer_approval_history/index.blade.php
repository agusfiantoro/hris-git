...
@section('title', 'Transfer Approval History')
    ...
    <div class="col-12">
        <div class="card card-danger card-outline">
            <div class="card-header">
                <h5 class="card-title">Transfer Approval History
                </h5>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.edit', function() {
        $('#modalEditTitle').text('Transfer Request');
        ...
        $.ajax({
            ...
            success: (res) => {
                $('#modalAdd').find('.approve').attr('id-transfer-header', $(this).attr('id-transfer-header'));
                $('#modalAdd').find('.reject').attr('id-transfer-header', $(this).attr('id-transfer-header'));
    ...
    $('#assetGroupTable').DataTable({
        responsive: true,
        ajax: {
            url: "{{route('assets.transfer_approval_history')}}"
        },
        columnDefs: [
        ...
        columns: [
            ...
            { 
                ...
                render: (data, type, row) => {
                    return `
                        <span class="btn btn-warning edit" id-transfer-header="${data}"><i class="fas fa-eye" style="color:#fff;"></i></span>
                        `;
                }
            }
        ]
