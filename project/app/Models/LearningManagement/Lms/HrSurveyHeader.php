...
class HrSurveyHeader extends Model {
	...
	public static function getdata() {
		$data = DB::table('hr_survey_header as hsh')
				...
				->select('hsh.*', 'he.name', 'mgd.description as question_type', 'mgd2.description as survey_type', 'mgd2.code as survey_type_code')
	...
	public static function get_company_all() {
		$data = DB::table('master_company as mc')
				->select('mc.id_company as id', 'mc.company_name as text')
	...
	public static function get_survey_type() {
		$data = DB::table('master_general_data')
				...
				->whereRaw("(code = 'quiz' OR code = 'quiz_pretest' OR code = 'quiz_posttest' OR code = 'quiz_remidial')")
				->get();
		return $data;
	}
