...
class WarningLetter extends Model
{
	...
	public static function get_sp_employee($request)
	{
		...
		if ($request->category_type == "SP1") {
			...
			->whereNotExists(function ($query) {
				...
				->leftJoin('master_general_data AS mgd2', 'mgd2.id_general_data', '=', 'el2.id_category')
	...
	public static function get_category()
	{
		...
		->where('master_general_data.code','SP')
	...
	*/
		...
		->select(
			\DB::RAW('hr_employee.id_employee'),
			\DB::RAW('hr_employee.name')
		)
		->leftJoin('master_position_detail','master_position_detail.id_employee','=','hr_employee.id_employee')
