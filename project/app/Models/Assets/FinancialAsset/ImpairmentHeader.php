...
class ImpairmentHeader extends Model {
    use HasFactory, StandardModelScope;

    protected $table = 'asset.fa_impairment_header';
    protected $primaryKey = 'id_impairment_header';
    ...
    public function details() {
        return $this->hasMany(ImpairmentDetail::class, 'id_impairment_header', 'id_impairment_header');
    }
