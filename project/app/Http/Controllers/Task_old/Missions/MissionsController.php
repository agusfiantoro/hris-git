        ...
        if ($request->ajax()) {		
            ...
            return DataTables::of($data)
				...
				->addColumn('action', function($data) {
					...
					$button = '<button type="button" onclick="'.$onclick.'" class="btn-answer btn btn-success" style="padding:2px 5px 0px 5px;" title="Answer"><span style="font-size:16px;" class="fas fa-list-alt"></span></button> ';
					$button .= '&nbsp;<button type="button" onclick="'.$onSubmit.'" class="btn-submit btn btn-success" style="padding:2px 5px 0px 5px;" title="Submit"><span style="font-size:14px;" class="fas fa-check" style="color:white;"></span></button>';
