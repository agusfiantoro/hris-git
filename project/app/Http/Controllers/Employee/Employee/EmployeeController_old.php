...
=======
    ...
    public function _export_attendance(Request $request) {
        ...
        $workDays = DB::table('hr_work_days')
	        ...
	        if($id_company != 'null'){
	        	$workDays->where('id_company', $id_company);
	        }
        ...
        $dataSheet = [
            [''],
            ['Attendance Status Report '.$companyName ],
            ['From '.$dateRangeName],
            [''],
        ];
     ...
     public function _export_employee(Request $request) {
        ...
        if($id_company == 'null'){
    		...
    		$get = DB::table(DB::raw("sp_funct_get_employee_report_all ('".$id_company."') sfgera"))
    			->select('sfgera.*')
                ->whereIn('sfgera.status_active', $status);
        ...
        $exportType = 'excel';
        $filename   = 'employee-report-'.$companyName;
        $spreadsheet = new Spreadsheet(); 
        $spreadsheet->removeSheetByIndex(0); // hapus sheet default bawaan
...
>>>>>>> 24cff8b05c27b435680481366697ac98e0fd0340
    }
}
